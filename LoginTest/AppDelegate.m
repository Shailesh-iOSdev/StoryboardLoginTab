...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    BOOL eulaAccepted = [[NSUserDefaults standardUserDefaults] boolForKey:@"eulaaccepted"];

    if (!eulaAccepted)
    {
        UIViewController* languageController = [storyboard  instantiateViewControllerWithIdentifier:@"languageviewcontroller"];
        UINavigationController* navigation = [[UINavigationController alloc] initWithRootViewController:languageController];
